    ...
    return (
        {
            ...
            content: (
                <div className="flex relative items-center justify-center h-full w-full group" >
                    <PageLinkIcon />
...
export const LinkedInBox: BentoBoxGridItem = {
    colSpanClass: "col-span-1 lg:col-span-1", rowSpanClass: "row-span-1",
    content: (
        <div className= "flex relative items-center justify-center h-full w-full group active:shadow-[inset_0px_8px_12px_rgba(0,0,0,0.4)]" >
        <PageLinkIcon />
    ...
    return (
        {
            ...
            content: (
                <div className= "flex relative items-center justify-center h-full w-full group active:shadow-[inset_0px_8px_12px_rgba(0,0,0,0.4)]" >
                    <div className="absolute top-0 right-0 group-hover:animate-bounce">
                        <FaLink />
                    </div>
