...
export default function HololensPage() {
    ...
    const projectsForBentoGrid: BentoBoxGridItem[] = [
        ...
        {
            colSpanClass: "col-span-2 lg:col-span-3", rowSpanClass: "row-span-5 sm:row-span-4 lg:row-span-4 xl:row-span-3", backgroundColor: 'bg-[#F5918D]',
            content: (
        ...
        {
            colSpanClass: "col-span-2 lg:col-span-3", rowSpanClass: "row-span-6 lg:row-span-5 xl:row-span-4", backgroundColor: 'bg-[#FCBB21]',
            content: (
        ...
        {
            colSpanClass: "col-span-2 lg:col-span-3", rowSpanClass: "row-span-4 sm:row-span-3 xl:row-span-2", backgroundColor: 'bg-[#f76135]',
            content: (
                <div className='lg:space-y-4 space-y-2'>
